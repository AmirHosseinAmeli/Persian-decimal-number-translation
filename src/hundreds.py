...
class Hundreds(DecimalGroup):
    ...
    def __init__(self):
        ...
        alphabet_pats = '(?:(' + unity_pats + ')\s*@hundreds.1|(@hundreds.1|@hundreds.2|@hundreds.3|@hundreds.5))' + \
    ...
    def _capturing_pats(self):
        return '(?:' + self.alphabet_pats + ')|(?:' + \
               self.numeric_pats + ')|(?:' + self.two_digits.non_capturing_pats() + ')'
